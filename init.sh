...
echo '    rm -rf production/play24-slick30-play2-auth-mysql-1_0_0' >> "seven_script"
echo '    unzip workspace/play24-slick3.0-play2-auth-mysql/target/universal/play24-slick30-play2-auth-mysql-1_0_0.zip -d production/' >> "seven_script"
echo '    cd production/play24-slick30-play2-auth-mysql-1_0_0/bin/' >> "seven_script"
echo '    echo "play24-slick30-play2-auth-mysql start"' >> "seven_script"
echo '    ./play24-slick30-play2-auth-mysql' >> "seven_script"
echo '    ;;' >> "seven_script"
echo '  stop)' >> "seven_script"
echo '    kill $(cat /home/ubuntu/production/play24-slick30-play2-auth-mysql-1_0_0/RUNNING_PID)' >> "seven_script"
echo '    ;;' >> "seven_script"
echo '  *)' >> "seven_script"
